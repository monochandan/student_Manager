...
<br><br><center><font color="white" size="6">Student Login</font></center>
...
<form action="signin.php" method="post">
			...
			<div class="sign-in-htm">
				<div class="group">
					<label for="user" class="label"><font color = "white"><b>ID</b></font></label>
					<input id="user" name="ID" type="text" class="input">
				</div>
				<div class="group">
					<label for="pass" class="label"><font color ="white"><b>Password</b></font></label>
				...
				<div class="foot-lnk">
					<label for="tab-2"><font color ="white"> Don't have account?</font></a>
				</div>
			</div>
</form>
			...
			<div class="sign-up-htm">
				<div class="group">
					<label for="user" class="label"><font color ="white">ID</font></label>
					<input id="user" name="id" type="text" class="input">
				</div>
				<div class="group">
					<label for="pass" class="label"><font color ="white">Email Address</font></label>
					<input id="pass" name="mail" type="text" class="input">
				</div>
				<div class="group">
					<label for="pass" class="label"><font color ="white">Phone</font></label>
...
<?php
        ...
        include "connect.php";
        $i = mysql_query("insert into user(ID,Email,Phone,Password) values('".$id."','".$mail."','".$phone."','".$pass."')");
        if($i==true){
